...
CH=224:FOR A%={$udgs} TO &CFF STEP 8:VDU23,CH:FOR B%=0TO 7:VDU?(A%+B%):NEXT:CH=CH+1:NEXT
ONERRORGOTO{$L1920}
...
FORF=0TO4:F?{$score_chars}=230:NEXT:LI=4:SC=1:?{$L0AF2}=60:GO=0 
{:L100}
FORF=1TO3:VDU19,F,0;0;:NEXT
PRINTTAB(0,5);:COLOUR3:GCOL0,1::ON SC GOSUB{$L540},{$L600},{$L680},{$L740}
!{$ghosts_table}=0:!&CFB=0:COLOUR1:PRINTTAB(14,1);:VDU240,241,242
...
IFLI=1GOTO{$L160}
FORF=0TO((LI-2)*16)STEP16:FORG=0TO15STEP4:G!(F+&7D80)=G!{$sprite_pl_facing}:G!(F+&7EC0)=G!&990:NEXT,
{:L160}
?{$bonus_chars}=235:?&E01=230:COLOUR2:PRINTTAB(18,1);:VDU235,230
...
FORG=0TO4STEP2:N=G?&CF9*256+G?{$ghosts_table}:IFN>&5800 FORF=0TO15STEP4:F!N=F!{$sprite_ghost_happy_row0}:F!(N+320)=F!{$sprite_ghost_happy_row1}:NEXT
...
END
{:L370}
IF?{$L0070}=192 FORJ=0TO15STEP4:J!&5CC0=0:J!&5CD0=J!{$sprite_pl_facing}:J!&5E00=0:J!&5E10=J!&990:NEXT
...
FORF=1TO1000:NEXT:SOUND&10,1,2,2:FORF=0TO15STEP4:F!&5CD0=0:F!&5E10=0:NEXT:FORF=0TO15STEP4:F!&5A50=F!{$sprite_pl_facing}:F!&5B90=F!&990:NEXT:FORF=1TO500:NEXT:FORF=0TO15STEP4:F!&5A50=0:F!&5B90=0:NEXT
...
FORG=0TO4STEP2:N=G?&CF9*256+G?{$ghosts_table}:IFN>&5800 FORF=0TO15STEP4:F!N=0:F!(N+320)=0:NEXT, ELSENEXT
SOUND&10,-15,7,255:FORJ=7TO0STEP-1:SOUND&11,-8,J*16,1:FORH=1TO200:NEXT
FORG=0TO4STEP2:N=G?&CF9*256+G?{$ghosts_table}:IFN>&5800 FORF=J TO15STEPJ+1:F?N=F?{$sprite_ghost_happy_row0}:F?(N+320)=F?{$sprite_ghost_angry_row1}:NEXT
NEXT,:SOUND&10,0,0,0
FORF=1TO1000:NEXT:FORH=1TO5:SOUND&10,1,2,2:FORF=0TO15STEP4:F!&5CD0=0:F!&5E10=0:NEXT:FORF=0TO15STEP4:F!&5B90=F!{$sprite_pl_facing}:F!&5CD0=F!&990:NEXT:FORF=1TO200:NEXT:FORF=0TO15STEP4:F!&5B90=0:F!&5CD0=0:NEXT
GCOL0,2:MOVE0,952:PLOT21,1279,952
FORF=0TO15STEP4:F!&5CD0=F!{$sprite_pl_facing}:F!&5E10=F!&990:NEXT:FORF=1TO200:NEXT
NEXT:FORF=0TO15STEP4:F!&5CD0=F!{$sprite_pl_right_0}:F!&5E10=F!&910:NEXT
...
N=&5BC0:FORF=0TO15STEP4:F!N=F!{$sprite_pl_facing}:F!(N+320)=F!&990:NEXT:COLOUR1:PRINTTAB(2,4);" = YOU!!"
