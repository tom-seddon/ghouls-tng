...
CH=224:FOR A%=&C00 TO &CFF STEP 8:VDU23,CH:FOR B%=0TO 7:VDU?(A%+B%):NEXT:CH=CH+1:NEXT
ONERRORGOTO{$L1920}
...
FORF=0TO4:F?&E10=230:NEXT:LI=4:SC=1:?&AF2=60:GO=0 
{:L100}
FORF=1TO3:VDU19,F,0;0;:NEXT
PRINTTAB(0,5);:COLOUR3:GCOL0,1::ON SC GOSUB{$L540},{$L600},{$L680},{$L740}
!&CF8=0:!&CFB=0:COLOUR1:PRINTTAB(14,1);:VDU240,241,242
...
IFLI=1GOTO{$L160}
FORF=0TO((LI-2)*16)STEP16:FORG=0TO15STEP4:G!(F+&7D80)=G!&980:G!(F+&7EC0)=G!&990:NEXT,
{:L160}
?&E00=235:?&E01=230:COLOUR2:PRINTTAB(18,1);:VDU235,230
FORF=0TO31:F?&DDE=0:NEXT:FORF=0TO4:PRINTTAB(F,1);CHR$(F?&E10):NEXT
FORF=0TO31STEP4:F!&5CE0=F!{$gmc.sprite_goal_row0}:F!&5E20=F!{$gmc.sprite_goal_row1}:NEXT
VDU23,0,1,0;0;0;0;:VDU19,1,1;0;19,2,3;0;:IFSC<>2VDU19,3,SC+3;0; ELSEVDU19,3,2;0;
SOUND&12,4,0,18:SOUND&13,4,1,18:FORF=1TO41STEP.2:VDU23,0,1,F;0;0;0;:NEXT
!&70=&7A00:FORF=0TO GO STEP2:G=&6000+(RND(300)*16):F!&CF8=G:NEXT:?&AEA=31
?&7D=0:?&84=0
CALL{$gmc.entry_game}:CALL{$gcode.clear_keyboard_buffer}
IF?&AF9=255GOTO{$L370}
FORG=0TO4STEP2:N=G?&CF9*256+G?&CF8:IFN>&5800 FORF=0TO15STEP4:F!N=F!&2020:F!(N+320)=F!&2030:NEXT
NEXT:N=?&7B*256+?&7A:FORF=0TO31STEP4:F!N=F!&9E0:NEXT:N=?&83*256+?&82:IFN>&5800 FORF=0TO31STEP4:F!N=F!&A70:F!(N+320)=F!&A90:NEXT
SOUND&10,-15,3,18:FORF=200TO0STEP-.6:SOUND&11,0,F,1:NEXT:N=?&71*256+?&70:IF?(N+326)=224N=N+320 ELSEIF?(N-314)=224N=N-320
K=110:FORG=&2040 TO &20B0 STEP16:FORF=0TO15STEP4:F!N=F!G:NEXT
...
FORF=0TO15STEP4:F!N=F!&A50:NEXT:FORG=0TO35STEP35:FORF=G TO G+40STEP1.5:SOUND&11,-15,F,1:NEXT:FORH=1TO400:NEXT:FORH=0TO15STEP4:H!N=H!&DDE:NEXT,
LI=LI-1:IFLI=0GOTO{$L1000}
FORF=1TO3000:NEXT
SOUND&10,4,4,18:CALL&2100:VDU23,0,13,0;0;0;0;
GOTO{$L100} 
NEXT
END
{:L370}
IF?&70=192 FORJ=0TO15STEP4:J!&5CC0=0:J!&5CD0=J!&980:J!&5E00=0:J!&5E10=J!&990:NEXT
...
?&AF2=?&AF2-5:IF?&AF2<20?&AF2=20
SC=SC+1:IFSC=5:PROCtower:GOTO{$L100}
CALL&380
SOUND&11,2,2,50:SOUND&12,2,130,50:FORF=0TO15STEP4:F!&5CE0=F!&2020:F!&5CF0=F!&2020:F!&5E20=F!&2030:F!&5E30=F!&2030:NEXT
FORF=1TO1000:NEXT:SOUND&10,1,2,2:FORF=0TO15STEP4:F!&5CD0=0:F!&5E10=0:NEXT:FORF=0TO15STEP4:F!&5A50=F!&980:F!&5B90=F!&990:NEXT:FORF=1TO500:NEXT:FORF=0TO15STEP4:F!&5A50=0:F!&5B90=0:NEXT
...
G=999:F=999:H=999
VDU30:FORF=0TO31:VDU11
IFINKEY(-255)=0I=INKEY(2)
NEXT:CLS
CLS:GOTO{$L100}
END
{:L540}
REM ***SCENE1*** 
!&84=&1800:CALL&D01:VDU5:MOVE364,28:PRINT"SPECTRES' LAIR":VDU4
COLOUR1:PRINTTAB(7,23);CHR$228:FORF=0TO15STEP4:F!&6BE0=F!&AB0:NEXT
COLOUR2:FORF=7TO12:PRINTTAB(F,27);CHR$243;TAB(F+2,22);CHR$243:NEXT:FORF=1TO2:PRINTTAB(F,4);CHR$243;TAB(F+5,4);CHR$243:NEXT
!&7A=&6A00:?&AF5=6:?&81=0:!&83=0:IFGO>0!&82=&6A10:?&AEB=8
RETURN
{:L600}
REM ***SCENE2***
!&84=&1A00:CALL&D01:VDU5:MOVE400,28:PRINT"HORRID HALL":VDU4
...
!&7A=&61A0:?&AF5=14:!&80=&6960:!&83=0
IFGO>0!&82=&6708:?&AEB=4
FORF=0TO15STEP4:F!&74D0=F!&AB0:NEXT
RETURN
{:L680}
REM ***SCENE3***
!&84=&1C00:CALL&D01:VDU5:MOVE332,28:PRINT"SPIDERS PARLOUR":VDU4
...
!&7A=&6A50:?&AF5=5:!&80=&6E60:!&82=&6130:?&AEB=12:FORF=0TO15STEP4:F!&7390=F!&AB0:NEXT 
RETURN
{:L740}
REM ***SCENE4***
!&84=&1E00:CALL&D01:VDU5:MOVE400,28:PRINT"DEATH TOWER":VDU4
...
!&7A=&6B50:?&AF5=8:!&80=&7360:!&82=&77A0:?&AEB=12:FORF=0TO15STEP4:F!&6D60=F!&AB0:F!&5F90=F!&AB0:NEXT
RETURN
DEFPROCtower:G=6:F=16:GO=GO+2:IFGO=6GO=4
FORG=0TO4STEP2:N=G?&CF9*256+G?&CF8:IFN>&5800 FORF=0TO15STEP4:F!N=0:F!(N+320)=0:NEXT, ELSENEXT
SOUND&10,-15,7,255:FORJ=7TO0STEP-1:SOUND&11,-8,J*16,1:FORH=1TO200:NEXT
FORG=0TO4STEP2:N=G?&CF9*256+G?&CF8:IFN>&5800 FORF=J TO15STEPJ+1:F?N=F?&2020:F?(N+320)=F?&2010:NEXT
NEXT,:SOUND&10,0,0,0
FORF=1TO1000:NEXT:FORH=1TO5:SOUND&10,1,2,2:FORF=0TO15STEP4:F!&5CD0=0:F!&5E10=0:NEXT:FORF=0TO15STEP4:F!&5B90=F!&980:F!&5CD0=F!&990:NEXT:FORF=1TO200:NEXT:FORF=0TO15STEP4:F!&5B90=0:F!&5CD0=0:NEXT
GCOL0,2:MOVE0,952:PLOT21,1279,952
FORF=0TO15STEP4:F!&5CD0=F!&980:F!&5E10=F!&990:NEXT:FORF=1TO200:NEXT
NEXT:FORF=0TO15STEP4:F!&5CD0=F!&900:F!&5E10=F!&910:NEXT
...
FORF=1TO2000:NEXT:CALL&2100
MODE7:VDU23;8202;0;0;0;
S=0:G=100000:FORF=0TO4:G=G/10:N=(F?&E10)-230:S=S+(N*G):NEXT
...
IFA$="N"ORA$="n" THEN !&262=1 ELSE !&262=0
REM***** BRIEF *****
PROCCLR
{:L1470}
...
N=&5BC0:FORF=0TO15STEP4:F!N=F!&980:F!(N+320)=F!&990:NEXT:COLOUR1:PRINTTAB(2,4);" = YOU!!"
N=N+960:FORF=0TO15STEP4:F!N=F!&2000:F!(N+320)=F!&2010:NEXT:COLOUR1:PRINTTAB(2,7);" = GHOUL"
N=N+960:FORF=0TO31STEP4:F!N=F!&A70:F!(N+320)=F!&A90:NEXT:COLOUR1:PRINTTAB(2,10);" = SPIDER"
N=N+960:FORF=0TO31STEP4:F!N=F!&9E0:NEXT:COLOUR1:PRINTTAB(2,12);" = MAGIC PLATFORM"
N=N+736:FORG=N TO N+196STEP8:FORF=0TO7STEP4:F!G=F!&A48:NEXT,:COLOUR3:PRINTTAB(0,14);CHR$224;TAB(18,14);CHR$224;CHR$224;:COLOUR1:PRINTTAB(2,15);" = MOVING FLOOR"
PRINTTAB(0,17);CHR$228;"  = DEADLY SPIKE";TAB(0,19);CHR$225;TAB(0,20);CHR$229;"  = SUPER SPRING"
N=&7380:FORF=0TO15STEP4:F!N=F!&AB0:NEXT:PRINTTAB(2,22);" = POWER JEWEL"
COLOUR2:PRINTTAB(0,24);CHR$243;CHR$243:COLOUR1:PRINTTAB(2,24);" = STRAY EDIBLES!"
N=N+1280:FORF=0TO31STEP4:F!N=F!&A00:F!(N+320)=F!&A20:NEXT:COLOUR1:PRINTTAB(2,27);" = STOLEN JEWELS"
...
END
DEFPROCASS
ENVELOPE1,1,0,0,0,0,0,200,0,0,0,-2,126,0
ENVELOPE2,2,1,-1,1,2,4,2,1,0,0,-1,100,0
ENVELOPE3,3,20,-20,8,5,5,5,0,0,0,-1,110,0
ENVELOPE4,2,0,0,0,0,0,255,3,0,0,-126,127,0 
ENDPROC
