...
CH=224:FOR A%={&udgs} TO {&udgs+255} STEP 8:VDU23,CH:FOR B%=0TO 7:VDU?(A%+B%):NEXT:CH=CH+1:NEXT
ONERRORGOTO{$L1920}
...
N=N+736:FORG=N TO N+196STEP8:FORF=0TO7STEP4:F!G=F!{&sprite_half_platform_QQQ+8}:NEXT,:COLOUR3:PRINTTAB(0,14);CHR$224;TAB(18,14);CHR$224;CHR$224;:COLOUR1:PRINTTAB(2,15);" = MOVING FLOOR"
