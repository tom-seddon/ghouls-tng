...
LDATA={&levels_org}+!({&levels_org}+SC*4):!{&level_draw_ptr}=LDATA:X%=GO:CALL{&entry_draw_level}:VDU5:MOVELDATA!{$level_name_x_offset},28:PRINT$(LDATA+{$level_name_offset}):VDU4
